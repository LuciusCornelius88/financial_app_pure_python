from config import error_code, stop_function_code, interruption_message, id_delimiter, exit_code


class SourceDeletionInterface:
    ...
    def delete(self):
        ...
        while True:
            ...
            if instance_id == error_code:
                ...
                return self.__sources_storage.delete(instance_id)
