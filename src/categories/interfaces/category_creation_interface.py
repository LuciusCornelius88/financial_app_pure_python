...
class CategoryCreationInterface:
    def __init__(self, default_name=None, default_balance=None) -> None:
        self.exit_code = exit_code
        self.default_input = default_input
        self.default_name = default_name if default_name else 'Category'
        self.default_balance = default_balance if default_balance else 0
        self.create_name_prompt = (f'Enter name of the category or enter "{self.default_input}" to set to default '
